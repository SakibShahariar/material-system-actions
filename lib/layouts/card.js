...
export class CardStyle extends BaseStyle {
    buildUI() {
        ...
        const box = new St.BoxLayout({vertical: true, style_class: 'sa-panel sa-layout-card', style: 'spacing: 10px; padding: 20px;'});
        ...
        box.add_child(new St.Label({text: 'System actions', style_class: 'sa-heading sa-title', x_align: Clutter.ActorAlign.CENTER, style: 'margin-top: 8px;'}));
    ...
    _section(title, actions) {
        const sec = new St.BoxLayout({vertical: true, style: 'spacing: 8px; margin-top: 6px;'});
