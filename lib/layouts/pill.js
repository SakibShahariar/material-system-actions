...
export class PillStyle extends BaseStyle {
    buildUI() {
        const box = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style_class: 'sa-panel sa-layout-pill', style: 'spacing: 14px; min-width: 340px; padding: 20px;'});
