...
export class RadialStyle extends BaseStyle {
    buildUI() {
        ...
        const hubBox = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, x_align: Clutter.ActorAlign.CENTER, y_align: Clutter.ActorAlign.CENTER});
        ...
        for (let i = 0; i < this.actions.all.length; i++) {
            ...
            const col = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 4px;', x_align: Clutter.ActorAlign.CENTER});
