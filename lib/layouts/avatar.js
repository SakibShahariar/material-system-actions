...
export class AvatarStyle extends BaseStyle {
    buildUI() {
        ...
        const avatar = new St.Label({text: (GLib.get_user_name()||'U').slice(0,2).toUpperCase(), style_class: 'sa-avatar sa-avatar-neutral', style: 'width: 120px; height: 120px; border-radius: 999px; font-size: 2.2em; text-align: center;'});
