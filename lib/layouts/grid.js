...
export class GridStyle extends BaseStyle {
    buildUI() {
        const box = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style_class: 'sa-panel-flat sa-mono sa-layout-grid', style: 'min-width: 480px;'});
    ...
    _tile(action, badgeNum) {
        ...
        const content = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 8px;', x_align: Clutter.ActorAlign.CENTER, y_align: Clutter.ActorAlign.CENTER});
        if (badgeNum != null) {
