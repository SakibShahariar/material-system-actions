...
export class ListStyle extends BaseStyle {
    buildUI() {
        const box = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style_class: 'sa-panel-flat sa-mono sa-layout-list', style: 'min-width: 360px;'});
        ...
        this._rows = [];
        this._idx = 0;
        const list = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 2px; padding: 6px 0;'});
