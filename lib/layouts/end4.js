...
// Port of End4Window:1355 — end-4/dots-hyprland rounded pill rows
...
export class End4Style extends BaseStyle {
    buildUI() {
        const box = new St.BoxLayout({vertical: true, style_class: 'sa-panel', style: 'spacing: 8px; min-width: 320px; padding: 16px;'});
    ...
    _tile(action, w, h, iconSize, round) {
        ...
        const content = new St.BoxLayout({vertical: true, x_align: Clutter.ActorAlign.CENTER, y_align: Clutter.ActorAlign.CENTER, style: 'spacing: 4px;'});
