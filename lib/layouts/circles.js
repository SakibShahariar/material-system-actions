...
export class CirclesStyle extends BaseStyle {
    buildUI() {
        const box = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style_class: 'sa-panel sa-layout-circles', style: 'spacing: 12px; padding: 16px; min-width: 76px;', x_align: Clutter.ActorAlign.CENTER});
