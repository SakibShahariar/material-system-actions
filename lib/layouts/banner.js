...
export class BannerStyle extends BaseStyle {
    buildUI() {
        const box = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style_class: 'sa-panel-flat sa-layout-banner', style: 'min-width: 360px; border-radius: 24px; overflow: hidden;'});
        ...
        const footer = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 8px; padding: 8px 14px 14px;'});
