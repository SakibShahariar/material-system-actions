...
export class DockStyle extends BaseStyle {
    buildUI() {
        ...
        const box = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style_class: 'sa-panel sa-layout-dock', style: 'spacing: 10px; padding: 14px 10px; min-width: 72px;'});
