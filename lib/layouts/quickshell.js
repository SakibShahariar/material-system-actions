...
// Port of QuickshellWindow:887 — big clock + circular icon dock, split panel
...
export class QuickshellStyle extends BaseStyle {
    buildUI() {
        const outer = new St.BoxLayout({style_class: 'sa-panel', style: 'spacing: 28px; padding: 20px;'});
