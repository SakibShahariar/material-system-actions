...
export class SplitStyle extends BaseStyle {
    buildUI() {
        ...
        const left = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 2px; min-width: 160px;'});
        ...
        const icons = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 14px;'});
        let row = null;
    ...
    _circleWithLabel(action) {
        ...
        const col = new St.BoxLayout({orientation: Clutter.Orientation.VERTICAL, style: 'spacing: 6px;', x_align: Clutter.ActorAlign.CENTER});
